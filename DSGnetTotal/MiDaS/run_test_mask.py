...
if __name__ == "__main__":
    ...
    run(r'/mnt/lwp/mmdetection_final_clean_test/maskedpic', r'/mnt/lwp/mmdetection_final_clean_test/depth_map_mask', args.model_weights, args.model_type, args.optimize)