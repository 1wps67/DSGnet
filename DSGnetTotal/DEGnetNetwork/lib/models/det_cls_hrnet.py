...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, cfg, **kwargs):
        ...
        '''
        self.classifier0 = nn.Linear(2048, 1024)
        self.classifier1 = nn.linear(1024,256)
        self.classifier2 = nn.linear(68,256)
        self.classifier3 = nn.linear(256,128)
        self.classifier4 = nn.linear(128,2)
        
        y1 = self.classifer0(y)
        y2 = self.classifer1(y1)
        label = self.classifer2(y2)
        y2.cat(label,dim = 0)
        y3 = self.classifer3(y2)
        yout = self.classifer4(y3)
...
def get_cls_net(config,**kwargs):
    ...
    #model.init_weights(r'/home/wh/lwp/hrnet-class/HRNet-Image-Classification-master/hrnetv2_w18_imagenet_pretrained.pth')
    #model.init_weights(r'/home/wh/lwp/hrnet-class/HRNet-Image-Classification-master/model_best_addkeypoints.pth.tar')
